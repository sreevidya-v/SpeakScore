...
async def analyze_pronunciation(
    ...
    try:
        ...
        return build_response(words_with_analysis, duration)
    finally:
        # Cleanup: get_duration_seconds() creates a temporary file (ffprobe input) that is
        # cleaned up in its finally block. No other temporary audio files persist beyond
        # their function scope: transcode_to_wav uses in-memory pipes, transcribe and
        # phoneme functions use BytesIO buffers that are garbage-collected automatically.
        pass
